...
export default function MobileBottomNav() {
  ...
  return (
    <div className="md:hidden flex items-center justify-around bg-[#121212]/70 backdrop-blur-2xl transform-gpu border-t border-white/10 h-[56px] pb-[env(safe-area-inset-bottom)] px-4 z-50 rounded-t-2xl shadow-[0_-8px_30px_rgba(0,0,0,0.4)] mt-[-1px]">
